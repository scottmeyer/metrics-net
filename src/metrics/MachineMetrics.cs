...
namespace metrics
{
    ...
    public  class MachineMetrics
    {
        ...
        {
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Current Disk Queue Length", TotalInstance, ".physical_disk.current_disk_queue_length");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Avg. Disk Queue Length", TotalInstance, ".physical_disk.avg_disk_queue_length");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Avg. Disk Read Queue Length", TotalInstance, ".physical_disk.disk_read_queue_length");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Avg. Disk Write Queue Length", TotalInstance, ".physical_disk.disk_write_queue_length");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "% Disk Time", TotalInstance, ".physical_disk.percent_disk_time");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "% Disk Read Time", TotalInstance, ".physical_disk.percent_disk_read_time");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "% Disk Write Time", TotalInstance, ".physical_disk.percent_disk_write_time");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Avg. Disk sec/Transfer", TotalInstance, ".physical_disk.avg_disk_seconds_per_transfer");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Avg. Disk sec/Read", TotalInstance, ".physical_disk.avg_disk_seconds_per_read");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Avg. Disk sec/Write", TotalInstance, ".physical_disk.avg_disk_seconds_per_write");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Disk Transfers/sec", TotalInstance, ".physical_disk.disk_transfers_per_second");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Disk Reads/sec", TotalInstance, ".physical_disk.disk_reads_per_second");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Disk Writes/sec", TotalInstance, ".physical_disk.disk_writes_per_second");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Disk Bytes/sec", TotalInstance, ".physical_disk.disk_bytes_per_second");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Disk Read Bytes/sec", TotalInstance, ".physical_disk.disk_read_bytes_per_second");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Disk Write Bytes/sec", TotalInstance, ".physical_disk.disk_write_bytes_per_second");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Avg. Disk Bytes/Transfer", TotalInstance, ".physical_disk.avg_disk_bytes_per_transfer");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Avg. Disk Bytes/Read", TotalInstance, ".physical_disk.avg_disk_bytes_per_read");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Avg. Disk Bytes/Write", TotalInstance, ".physical_disk.avg_disk_bytes_per_write");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "% Idle Time", TotalInstance, ".physical_disk.percent_idle_time");
            Metrics.InstallPerformanceCounterGauge("PhysicalDisk", "Split IO/Sec", TotalInstance, ".physical_disk.split_io_per_second");
        }
